	...
	function gioithieu(){
		var x = '<b>Tên học phần: </b> <i>Công nghệ IoT và Ứng Dụng (IoT Technology and Applications)</i><br><b>- Mã số học phần: </b> <i>KC326</i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>- Khoa: </b><i>Công nghệ</i><br><b>- Số tín chỉ học phần: </b><i>02 tín chỉ</i> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>- Bộ môn: </b><i>Tự động hóa</i><br><b>- Số tiết học phần: </b><i>30 tiết lí thuyết và 30 tiết tự học&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</i><p style="font-size: 19px; text-align: justify;">IoT là công nghệ ứng dụng Internet để kết nối các thiết bị phần cứng theo nguyên lý không dây và tốc độ cao. Học phần này được xây dựng giúp sinh viên ngành Tự Động Hóa và Cơ Điện Tử trải nghiệm nguyên lý, thiết kế, kế nối, lập trình, thu thập dữ liệu thông qua giao diện web được lập trình theo khả năng của từng sinh viên qua các ứng dụng cơ bản được giới thiệu và hướng dẫn trên lớp của giảng viên.</p>'
	...
	function ppgiangday(){
		var x = '<p>Phương pháp giảng dạy: <b>Diễn giảng</b></p><p style="text-align: left; font-size: 19px;">Sinh viên phải thực hiện các nhiệm vụ như sau:<br>- Tham dự tối thiểu 80% số tiết học lý thuyết.<br>- Thực hiện đầy đủ các bài ¡ tập nhóm/ bài tập và được đánh giá kết quả thực hiện.<br>- Tham dự báo cáo thiết kế giữa kỳ về ý tưởng, chương trình phần mềm, cấu trúc phầncứng.<br>- Tham dự báo cáo. cuối kỳ về hệ thống ứng dụng điều khiển, giám sát qua Internet sử dụng kiến thức đã học.<br>- Chủ động tổ chức thực hiện giờ tự học.</p>'			
		document.getElementById('noidung').innerHTML= x
		document.getElementById('mid').style.marginTop= '7%'
		document.getElementById('btn').innerHTML='Quay lại trang chủ'
		document.getElementById('dropdown-content').innerHTML= ''
