	...
	function gioithieu(){
		var x = '<b>Tên học phần: </b> <i>Công nghệ IoT và Ứng Dụng (IoT Technology and Applications)</i><br><b>- Mã số học phần: </b> <i>KC326</i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>- Khoa: </b><i>Công nghệ</i><br><b>- Số tín chỉ học phần: </b><i>02 tín chỉ</i> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>- Bộ môn: </b><i>Tự động hóa</i><br><b>- Số tiết học phần: </b><i>30 tiết lí thuyết và 30 tiết tự học&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</i><p style="font-size: 16px; text-align: justify;">IoT là công nghệ ứng dụng Internet đẻ kết nối các thiết bị phần cứng theo nguyên lý không dây và tốc độ cao. Học phần này được xây dựng giúp sinh viên ngành Tự Động Hóa và Cơ Điện Tử trải nghiệm nguyên lý, thiết kế, kế nối, lập trình, thu thập dữ liệu thông qua giao diện web được lập trình theo khả năng của từng sinh viên qua các ứng dụng cơ bản được giới thiệu và hướng dẫn trên lớp của giảng viên.</p>'
		document.getElementById('noidung').innerHTML= x
		document.getElementById('mid').style.marginTop= '7%'
		document.getElementById('btn').innerHTML='Trở lại'
		document.getElementById('dropdown-content').innerHTML= ''
	}

	function muctieu(){
		var x = '<table><thead><tr><th class="smallcoll">Mục tiêu</th><th>Nội dung mục tiêu</th><th class="smallcoll">CĐR<br>CTĐT</th></tr></thead><tbody><tr><td class="smallcoll">4.1</td><td class="bigcoll">Trình bày được nguyên lý cơ bản vể IoT, nguyên lý thiết kế, kết nối và truyền dữ liệu trong các ứng dụng IoT trong các lĩnh vực điện tử.</td><td class="smallcoll">2.1.1b;<br>2.1.3a</td></tr><tr><td class="smallcoll">4.2</td><td class="bigcoll">Thực hiện được một hệ thống cơ điện tử có ứng dụng công nghệ IoT cơ bản đáp ứng được yêu cầu thực tế có quan tâm đến tác động của các giải pháp IoT trong cơ điện tử đối với một trong hau lĩnh vực sản xuất nông nghiệp và thủy sản.</td><td class="smallcoll">2.1.2a;<br>2.2.1a;<br>2.2.1b</td></tr><tr><td class="smallcoll">4.3</td><td class="bigcoll">Có khả năng nhận ra được trách nhiệm về nghề nghiệp và đạo đức trong sản phẩm đã thiết kế, đánh giá được tác động của sản phẩm thiết kế đến môi trường và xã hội.</td><td class="smallcoll">2.1.3b;<br>2.3a</td></tr><tr><td class="smallcoll">4.4</td><td class="bigcoll">Có khả năng làm việc và giao tiếp hiệu quả trong nhóm chuyên ngành, tham khảo được các tài liệu chuyên ngành, hình thành ý thức và năng lực học tập suốt đời.</td><td class="smallcoll">2.2.2a;<br>2.2.2b;<br>2.3b</td></tr></tbody></table>'
		document.getElementById('noidung').innerHTML= x
	...
	function ppgiangday(){
		...
		document.getElementById('noidung').innerHTML= x
		document.getElementById('ppgiangday-a').innerHTML='Trở lại'
		document.getElementById('mid').style.marginTop= '7%'
		document.getElementById('btn').innerHTML='Trở lại'
		document.getElementById('dropdown-content').innerHTML= ''
	}
	...
	function cacdanhgia(){
		...
		document.getElementById('cacdanhgia-a').innerHTML='Trở lại'
		document.getElementById('btn').innerHTML='Trở lại'
		document.getElementById('dropdown-content').innerHTML= ''
	}
